...
#------------------------------------------------------------------------------
# 2014/04/20 ver.2.01 微バグを修正
# 2014/04/11 ver.2.00 「カーソルの記憶」の追加をはじめとした様々な更新を適用
#                     旧版とのセーブデータの互換性なし
# 2012/07/28 ver.1.02 不要処理を削除
# 2012/07/24 ver.1.01 Window_Base の initialize メソッドを再定義ではなく、
#                     alias に変更
# 2012/07/24 ver.1.00 公開
#==============================================================================
